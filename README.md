...
1. Download the plugin: Grab the current release from [here](https://github.com/MarvinMenzerath/DoomThemAll/releases) or a development-version from [here](http://ci.menzerath.eu/job/DoomThemAll/) and put it in your plugins-folder.
